...
//CD3DX12_CPU_DESCRIPTOR_HANDLE cpuDescriptorHandle, CD3DX12_GPU_DESCRIPTOR_HANDLE gpuDescriptorHandle, UINT descriptorSize
{
    ...
    mBlur0CpuSrv = ResourceManager.AllocShaderResource();
    mBlur0CpuUav = ResourceManager.AllocShaderResource();
    mBlur1CpuSrv = ResourceManager.AllocShaderResource();
    mBlur1CpuUav = ResourceManager.AllocShaderResource();

    mBlur0GpuSrv = ResourceManager.AllocGPUShaderResource();
    mBlur0GpuUav = ResourceManager.AllocGPUShaderResource();
    mBlur1GpuSrv = ResourceManager.AllocGPUShaderResource();
    mBlur1GpuUav = ResourceManager.AllocGPUShaderResource();
...
void BlurFilter::Run(RenderTarget* source, ID3D12GraphicsCommandList* cmdList)
{}
